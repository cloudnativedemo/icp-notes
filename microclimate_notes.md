...
__1. Create pipeline deployment namespace
```
kubectl create namespace microclimate-pipeline-deployments
```

__2. Edit ClusterImagePolicy
```
...
__3. Create Docker Registry secret to microclimate namespace
```
...
__6. Create Docker Registry secret for `microclimate-pipeline-deployments` namespace
```
...
__7. Update ImagePullSecret for `microclimate-pipeline-deployments` namespace
```
