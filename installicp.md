...
|--------------------------------------------------|--------|-----|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------------|
| Boot                                             | 1      | 2   | 4        | /: 60 GB /var/lib/docker: 150 GB<br> /var/lib/kubelet: 10 GB<br> /nfsvol: 100GB                                                                                        | ext4, or,xfs (ftype=1) | RHEL 7.3 or above, or Ubuntu 16.01 |
| Master/proxy                                     | 1      | 8   | 16       | /: 60 GB /var: 240GB<br> /var/lib/docker: 150 GB<br> /var/lib/etcd: 15 GB<br> /var/lib/icp: 100 GB<br> /var/lib/mysql: 10 GB<br> /var/lib/registry: 100 GB<br> /var/lib/kubelet: 10 GB | ext4, or,xfs (ftype=1) | RHEL 7.3 or above, or Ubuntu 16.01 |
| Worker                                           | 3      | 4   | 16       | /: 60 GB<br> /var/lib/docker: 150 GB<br> /var/lib/kubelet: 10 GB                                                                                                       | ext4, or,xfs (ftype=1) | RHEL 7.3 or above, or Ubuntu 16.01 |
| Mgmt + VA (optional for monitoring and security) | 1      | 12  | 14       | /: 60 GB<br> /var: 240GB<br> /var/lib/docker: 150 GB<br> /var/lib/icp: 100 GB<br> /var/lib/kubelet: 10 GB                                                                      | ext4, or,xfs (ftype=1) | RHEL 7.3 or above, or Ubuntu 16.01 |
